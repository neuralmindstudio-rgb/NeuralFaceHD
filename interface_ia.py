...
class TelaPrincipal(Screen):
    def __init__(self, **kw):
        ...
        self.barra_t.add_widget(self.btn_sair); self.barra_t.add_widget(self.btn_salvar)
        self.barra_t.add_widget(self.btn_share); self.barra_t.add_widget(self.lbl_rede)
        ...
        self.meio.add_widget(self.area_foto); self.meio.add_widget(self.barra_p)
        ...
        l1.add_widget(self.btn_b); l1.add_widget(self.btn_r)
        ...
        self.btn_limpar = MDRectangleFlatButton(text="LIMPAR", size_hint_x=0.25); self.btn_limpar.bind(on_release=self.limpar_tudo)
        self.btn_gerar = MDFillRoundFlatButton(text="GERAR", md_bg_color=(0.5, 0, 0.8, 1), size_hint_x=0.45); self.btn_gerar.bind(on_release=self.enviar_ao_pc)
        ...
        layout_geral.add_widget(self.barra_t); layout_geral.add_widget(self.meio); layout_geral.add_widget(self.painel)
    ...
    def select_path(self, path):
        ...
        if self.tipo_atual == "base":
            ...
            self.btn_idx.text = f"TROCAR ROSTO ({self.face_index})"; self.recriar_widget_imagem(path)
        else:
    ...
    def abrir_menu_salvamento(self, instance):
        ...
        content.add_widget(btn1); content.add_widget(btn2)
    ...
    def exibir_aviso_sem_creditos(self):
        self.dialogo_sem_creditos = MDDialog(
            ...
            text="Seus créditos acabaram! Deseja recarregar agora para continuar criando imagens incríveis?",
            buttons=[
    ...
    def processo_servidor(self):
        ...
        while tentativa_atual < tentativas_maximas and not sucesso_ia:
            try:
                ...
                # Usar user_data_dir garante que o Android permita o compartilhamento
    ...
    def exibir_termos_popup(self):
        # Texto atualizado conforme imagem enviada
        texto = (
