...
class TelaPrincipal(Screen):
    ...
    def __init__(self, **kw):
        ...
        self.barra_t = BoxLayout(
            size_hint=(1, None),
            height=dp(65), # Aumentei a altura total da barra
            spacing=dp(10),
        ...
        self.meio = MDBoxLayout(
            ...
            size_hint=(0.98, 0.30), # Foto menor para não bater em nada
            pos_hint={'center_x': 0.5, 'center_y': 0.57}, # Bem no meio da tela
            md_bg_color=(0, 0, 0, 0),
            padding=dp(2)
        )
